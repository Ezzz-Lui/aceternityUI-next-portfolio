...
export default function Home() {
  return (
    <>
      ...
      <section className="h-dvh w-full rounded-md justify-center items-center flex md:items-center md:justify-center bg-black antialiased bg-grid-white/[0.02] relative overflow-hidden">
        <Spotlight />
        <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
          ...
          <p className="subpixel-antialiased mt-4 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto">
            I&apos;m passionate about building digital solutions from start to
            finish. With a strong foundation in both frontend and backend
            development.
          </p>
          <h2 className="text-xl sm:text-2xl font-bold text-center text-stone-200 mt-8 mb-4">
            Building apps with
          </h2>
      ...
      {/* <section className="min-h-screen w-full bg-black">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-5xl font-bold text-stone-200 text-center mb-12">My Projects</h1>
