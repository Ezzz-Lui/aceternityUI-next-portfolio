...
export default function Home() {
  return (
    <>
      ...
      <section className="h-dvh w-full rounded-md justify-center items-center flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
        <Spotlight />
